      ...
      <Container>
        <div className="max-w-md mx-auto surface overflow-hidden">
          ...
          <div className="bg-[#1a3a52] px-6 py-8 text-center text-white relative">
            ...
            <p className="text-slate-300 text-sm mt-1 font-light">Secure access for PEPL partners</p>
          </div>
          ...
          <div className="p-6 sm:p-8">
              ...
              <form onSubmit={verifyOtp} className="space-y-5">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <button
                    ...
                    className="text-xs font-semibold text-slate-500 hover:text-[#1a3a52]"
                  >
            ...
            <div className="mt-8 text-center text-sm text-slate-600 border-t border-slate-100 pt-6">
              New supplier?{" "}
              <Link href="/supplier-register" className="font-bold text-[#1a3a52] hover:text-[#d41f3d] hover:underline">
                Register here
              </Link>
            </div>
          </div>
