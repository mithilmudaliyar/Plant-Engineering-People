        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_2fr] items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 mb-6">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-amber-500">Global Standards</span>
            </div>
            <h2 className="text-3xl font-black text-white sm:text-4xl leading-tight">
              Strategically Located in <span className="text-amber-400">Tarapur MIDC</span>
            </h2>
            <p className="mt-6 text-base text-slate-400 leading-relaxed">
              Our 5000+ MT capacity fabrication facility is situated in the heart of Maharashtra's premier industrial zone. This strategic location enables us to efficiently serve major nuclear and chemical installations across India and support global export requirements.
            </p>
          ...
          <div className="rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-slate-800 relative h-[450px]">
            <iframe 
              ...
              title="PEPL Location Map"
            />
            {/* L&T Style Overlay Badge */}
            <div className="absolute bottom-6 right-6 bg-white/95 backdrop-blur-md px-5 py-3 rounded border border-gray-200 shadow-xl flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#1a3a52] text-white">
              ...
              <div>
                <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">Headquarters</p>
                <p className="text-sm font-bold text-[#1a3a52]">Tarapur MIDC</p>
              </div>
            </div>
          </div>
        </div>
